...
public class Bank {
	...
	public void deposit(int accountNumber, double amount,String date,String description) {
		BankAccount account = storage.getAccountByNumber(accountNumber);
		account.deposit(amount, date, description);
	}

	public void withdraw(int accountNumber, double amount, String password,String date,String description) {
		// TODO Auto-generated method stub
		var account=storage.getAccountByNumber(accountNumber);
		account.withdraw(amount, password, date, description);
	}		
	...
	public void transfer(int source, double amount, String password, int target,String date,String description) {
		// TODO Auto-generated method stub
		BankAccount t= storage.getAccountByNumber(target);
		BankAccount s= storage.getAccountByNumber(source);
		
		s.withdraw(amount,password, date, description);
		t.deposit(amount, description, description);	
	}
